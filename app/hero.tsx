  ...
  return (
    ...
    >
      <div className="flex grow justify-center bg-black/50">
        <div className="flex flex-col max-w-6xl grow items-center px-8 sm:px-16 lg:px-32 lg:flex-row pt-12 lg:pt-0 text-right gap-10">
          <motion.div 
            className="grow"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          >
            <h2 className="text-white text-5xl font-serif">Hi, I&apos;m Joel 👋</h2>
