...
export default function PrivacyPolicy() {
  ...
  const siteName = "Joel Johnston",
    siteUrl = "https://www.joelj.ca",
    contactEmail = "me@joelj.ca",
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12 prose prose-invert prose-headings:mt-8 pt-20 text-lg">
      ...
      <section id="information-we-collect" className="mt-10">
        ...
        <h4 className="mt-6">a. Information You Provide</h4>
        <p>
          We collect personal information that you voluntarily provide, such as
          when you:
        </p>
        <ul className="list-inside list-disc">
          <li>Fill out forms or request information through HubSpot;</li>
          <li>Subscribe to our newsletter; or</li>
          <li>Contact us via email or web forms.</li>
        </ul>
        ...
        <h4 className="mt-6">b. Automatically Collected Information</h4>
        <p>
          When you visit our Site, we automatically collect certain data,
          including:
        </p>
        <ul className="list-inside list-disc">
          <li>IP address;</li>
          ...
          <li>Pages visited, time spent, and referring websites; and</li>
          <li>General (non-precise) geographic location.</li>
        </ul>
        <p>
      ...
      <section id="how-we-use" className="mt-10">
        ...
        <ul className="list-inside list-disc">
          ...
          <li>Send marketing and promotional communications (only if you’ve opted in);</li>
          <li>Analyze website traffic and user behavior via Google Analytics;</li>
          <li>Manage customer relationships and communications through HubSpot; and</li>
      ...
      <section id="cookies" className="mt-10">
        ...
        <h4 className="mt-6">a. Cookies</h4>
        <p>
          Cookies are small data files stored on your device that help improve
          user experience and website performance. You can disable cookies in
          your browser settings, but some features of the Site may not function
          properly as a result.
        </p>
        <h4 className="mt-6">b. Google Analytics</h4>
        <p>
          We use Google Analytics to understand how visitors interact with our
          website. Google Analytics collects information such as your IP
          address, browser type, and pages visited. This information is
        ...
        <h4 className="mt-6">c. HubSpot</h4>
        <p>
          We use HubSpot for CRM, marketing automation, and analytics. HubSpot
          may collect information through cookies and forms to help us
          understand visitor behavior and manage communications. You can learn
          more about HubSpot’s privacy practices here:
        </p>
        <p>
          <a
      ...
      <section id="sharing" className="mt-10">
        ...
        <ul className="list-inside list-disc">
          <li>
            Service providers (e.g., website hosting, analytics, CRM) who help
            operate our business;
          </li>
          <li>Legal authorities, if required by law or to protect our rights; and</li>
          <li>
            Successors or acquirers, in the event of a business transfer or
            merger.
          </li>
        </ul>
        <p>
          All third-party partners are required to handle your data securely and
      ...
      <section id="security" className="mt-10">
        ...
        <p>
          ...
          destruction. However, no internet-based service is completely secure.
        </p>
      </section>
      ...
      <section id="your-rights" className="mt-10">
        ...
        <ul className="list-inside list-disc">
          ...
          <li>Object to or restrict data processing; and</li>
      ...
      <section id="intl-transfers" className="mt-10">
        <h3>9. International Data Transfers</h3>
        <p>
          If you are accessing our Site from outside your country, please note
          that your information may be transferred to and processed in other
      ...
      <section id="children" className="mt-10">
        ...
        <p>
          Our Site is not directed to children under 13 (or 16 in some
          jurisdictions). We do not knowingly collect information from children.
        </p>
      </section>
