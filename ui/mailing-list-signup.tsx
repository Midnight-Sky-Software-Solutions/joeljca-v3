      ...
      <div id="mc_embed_signup">
        <form action="https://joelj.us17.list-manage.com/subscribe/post?u=c46f03c7a836863925e73b063&amp;id=3c5087667e&amp;f_id=00ea4ae0f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_self" noValidate>
          <div id="mc_embed_signup_scroll">
            <div className="mc-field-group py-5"><input type="email" name="EMAIL" className="text-black required email bg-white rounded-md px-2 w-full py-1" id="mce-EMAIL" required placeholder="Email address" /></div>
            ...
            <div className="optionalParent">
              <div className="clear foot">
                <input type="submit" name="subscribe" id="mc-embedded-subscribe" className="bg-blue-500 text-white text-md px-2 py-1 rounded-lg hover:cursor-pointer" />
              </div>
            </div>
          </div>
        </form>
